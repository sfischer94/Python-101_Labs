...
"""
# Create an empty string for python to log words and an empty string for the new text
# Have Python loop through and check if characters are alphabetic and add them to the word string
# For non alphabetic characters, check if there's any existing word
# Edge case: length of word is 1 (e.g. saying "A" or I") --> add them and the character to the new text. Wipe the word string. 
# For words longer than 1 character, move the 1st letter to the end, make the new first letter capitalized if the word was, and add it to the new text with the character. wipe the string.

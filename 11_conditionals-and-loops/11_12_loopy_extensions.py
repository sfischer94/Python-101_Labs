...
# Approach: Iterate through file. Once a period is reached, extract all characters after. Use if loop to check extension.
"""extension = ""
n = 0
...
# Alternative: Use the split() method
n = 0
for char in filename:
    if char == ".":
        extension = char + filename.split(char, 1)[1]
print(extension)
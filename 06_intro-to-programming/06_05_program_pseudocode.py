...
# Goal: Rename a list of files downloaded by appending a prefix
# Set up location where the files are
# Create loop to parse through files and append the prefix
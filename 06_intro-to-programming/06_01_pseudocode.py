...
# ---
# Create an empty list to hold the names of the kittens
# Create a function that confirms cuteness and adds the name to the list
# Display a message stating that they're ready for adoption